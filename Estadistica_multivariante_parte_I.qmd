...
Hay que hacer un gráfico de la distribución de una $\chi^2$ con $p$ grados de libertad (o simular 100 de manera random) y mostrar en el mismo gráfico la distribución de los $100$ valores del apartado a al cuadrado:
